...
{id:39,name:"陷阵营(高顺)",powerful:200,type:SkillType.ATTACK,subType:[SkillSubType.AMBUSH_INVERSE],ambush:1.1,ambushRects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:100,explanation:"{probability}几率相邻敌军大于1时攻击有加成，且相邻敌军越多攻击加成越多。"},

...
{id:17,name:"连环计(庞统)",powerful:200,type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.SPREAD],belong:Belong.ENEMY,speadProbability:10.5,speadRects:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],probability:160,explanation:"{probability}几率法术攻击时不断蔓延到其他相邻的敌军。"},
...
{id:98,name:"短刀",powerful:80,type:SkillType.CREATE,subType:[SkillSubType.SOLDIERS_ATTACK_RECT],condition:{type:"SoldierId",value:3},rangeAttack:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],explanation:"装备了短刀，在使用远程兵种时，可以近身攻击。"},
];
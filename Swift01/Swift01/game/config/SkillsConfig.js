...
{id:71,name:"突击(夏侯惇)",type:[SkillType.ATTACK],subType:[SkillSubType.ATTACK_COUNT,SkillSubType.FALL_BACK],attacks:[1.2],probability:35,explanation:"重击敌军的同时令敌军后退一格，如果后方存在部队无法后退时，则对后方部队产生撞击伤害。对建筑无效。"},
{id:72,name:"突破(乐进)",type:[SkillType.ATTACK],subType:[SkillSubType.BREAK_THROUGH],aids:[3],aidCount:1,aidRects:[{x:0,y:0}],probability:35,explanation:"提升自身防御之后穿透到敌军背后，如果后方存在部队无法后退时，则对后方部队产生撞击伤害。"},

...
{id:17,name:"连环计(庞统)",powerful:200,type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.SPREAD],speadProbability:10.5,speadRects:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],probability:160,explanation:"{probability}几率法术攻击时不断蔓延到其他相邻的敌军。"},

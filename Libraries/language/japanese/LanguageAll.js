...
Language.data = {
	...
	"null":"无",
	"single_combat_ask":"敵将{0}、俺と敢与我大战三百回合吗？",
	"single_combat_answer_ok":"那就让你做我的刀下鬼吧！",
	"single_combat_answer_no":"お前は俺と戦う資格がない!",
	
	"leader_change_talk":"やばい、主将が退却したため、糟糕!因为主将撤退，军队一盘散沙，能力都下降了。那就由我暂代主将来指挥战斗吧！",
	"gameover":"ゲームオーバー"
};
Language.itemData = {
	"item_name_1":"草药",

...
EventListView.prototype.updateMap=function(){
	var self = this;
...
EventListView.prototype.mapLayerInit=function(){
	var self = this;
...
EventListView.prototype.clickLeftArrow=function(event){
	var self = event.currentTarget.parent.parent;
...
EventListView.prototype.clickRightArrow=function(event){
	var self = event.currentTarget.parent.parent;
	if(self.listLayer.isMoving){
		return;
	}
...
EventListView.prototype.centerOnChild=function(){
	var self = this;
...
EventListView.prototype.moveLeft=function(){
	var self = this;
	if(self.listLayer.x >= 0){
		return;
	}
...
EventListView.prototype.moveRight=function(){
	var self = this;
...
EventListView.prototype.moveComplete=function(event){

function CharacterExpeditionReadyView(controller){
	var self = this;
	base(self,LView,[controller]);
	self.set();
}
CharacterExpeditionReadyView.prototype.layerInit=function(){
	var self = this;
...
CharacterExpeditionReadyView.prototype.set=function(){
	var self = this;
...
CharacterExpeditionReadyView.prototype.onchangeSoldier=function(event){
...
CharacterExpeditionReadyView.prototype.setSoldier=function(){
	var self = this;
	var soldiers = self.characterModel.soldiers();
...
CharacterExpeditionReadyView.prototype.onchangeTroop=function(event){
	var troopRange = event.currentTarget;
	var self = troopRange.parent.parent;
	self.setTroops();
};
CharacterExpeditionReadyView.prototype.setTroops=function(){
	var self = this;
...
CharacterExpeditionReadyView.prototype.apply=function(){
	var self = this;
	var troop = (self.maxTroops * self.troopRange.value * 0.01) >> 0;

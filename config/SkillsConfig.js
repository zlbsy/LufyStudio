...
{id:17,name:"连环计(庞统)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.SPREAD],speadProbability:0.4,speadRects:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],probability:40,explanation:"{probability}几率法术攻击时不断蔓延到其他相邻的敌军。"},
...
{id:33,name:"乱射(太史慈)",type:SkillType.ATTACK,subType:[SkillSubType.SPREAD],condition:{type:"AttackType",value:AttackType.FAR},speadProbability:0.4,speadRects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:40,explanation:"{probability}几率使用弓箭类兵种攻击时,使攻击波及到目标敌人相邻的敌军。"},

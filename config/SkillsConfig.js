...
{id:3,name:"隔山打牛(关羽)",type:SkillType.ATTACK,subType:[SkillSubType.ATTACK_RECT],attacks:[1.5],rects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:40,explanation:"{probability}几率使攻击波及到目标敌人相邻的敌军。"},
...
{id:10,name:"噬血(马超)",type:SkillType.ATTACK_END,subType:[SkillSubType.VAMPIRE],vampire:0.5,probability:40,explanation:"{probability}几率给在物理攻击对方时将敌军兵力转换为己方兵力。"},
...
{id:14,name:"反间计(陆逊,陆抗)",type:SkillType.STRATEGY_ATTACK_END,subType:[SkillSubType.VAMPIRE],vampire:0.5,probability:50,explanation:"{probability}几率在法术攻击对方时将敌军兵力转换为己方兵力。"},
{id:15,name:"识破(荀攸)",type:SkillType.NULL,subType:[SkillSubType.STRATEGY_HERT_MINUS],hert:0.5,minusRects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:100,explanation:"{probability}几率令自身及相邻的友军受到的法术伤害减半。"},
{id:16,name:"连珠(法正)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.STRATEGY_COUNT],strategy_attacks:[1,1],probability:60,explanation:"{probability}几率法术连击。"},
{id:17,name:"连环计(庞统)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.SPREAD],speadProbability:0.5,speadRects:[{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0}],probability:60,explanation:"{probability}几率法术攻击时不断蔓延到其他相邻的敌军。"},
{id:18,name:"鬼策(贾诩)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.STRATEGY_COUNT,SkillSubType.ENEMY_AID],strategy_attacks:[1.5],aids:[2,4,6,8,10],aidCount:1,aidRects:[{x:0,y:0}],probability:50,explanation:"{probability}几率1.5倍法术暴击，且降低敌军状态。"},
{id:19,name:"鬼谋(郭嘉)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.STRATEGY_COUNT,SkillSubType.ENEMY_AID],strategy_attacks:[1.5],aids:[21,22,23,24,25],aidCount:1,aidRects:[{x:0,y:0}],probability:50,explanation:"{probability}几率1.5倍法术暴击，且令敌军陷入不良状态。"},
{id:20,name:"逆嗜血(许褚)",type:SkillType.BACK_ATTACK_END,subType:[SkillSubType.VAMPIRE],vampire:0.5,probability:40,explanation:"{probability}几率反击时将敌军兵力转化为自身兵力。"},
{id:21,name:"反弹(典韦)",type:SkillType.HERT,subType:[SkillSubType.BOUNCE],bounce:0.5,probability:50,explanation:"{probability}几率被攻击时令敌军也受到一定程度伤害。"},
...
{id:33,name:"乱射(太史慈)",type:SkillType.ATTACK,subType:[SkillSubType.SPREAD],condition:{type:"AttackType",value:AttackType.FAR},speadProbability:0.5,speadRects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:40,explanation:"{probability}几率使用弓箭类兵种攻击时,使攻击波及到目标敌人相邻的敌军。"},
...
{id:38,name:"仁者(鲁肃,羊祜)",type:SkillType.BOUT_START,subType:[SkillSubType.ENLIST_SKILL],enlist_value:0.05,enlist_count:1,probability:50,explanation:"{probability}几率回合开始时为己方随机一人征集一些兵力。"},
{id:39,name:"陷阵营(高顺)",type:SkillType.ATTACK,subType:[SkillSubType.AMBUSH_INVERSE],ambush:1.1,ambushRects:[{x:0,y:0},{x:0,y:-1},{x:0,y:1},{x:-1,y:0},{x:1,y:0},{x:-1,y:-1},{x:1,y:1},{x:-1,y:1},{x:1,y:-1}],probability:100,explanation:"{probability}几率相邻敌军大于1时攻击有加成，且相邻敌军越多攻击加成越多。"},
...
{id:41,name:"小霸王(孙策)",type:SkillType.ATTACK,subType:[SkillSubType.ATTACK_COUNT,SkillSubType.ENEMY_AID],condition:{type:"StatusCompare",name:"force",value:1},attacks:[1.5],aids:[2],aidCount:1,aidRects:[{x:0,y:0}],probability:50,explanation:"{probability}几率对武力低于自己的敌军，进行1.5倍暴击，且令其攻击力降低。"},
{id:42,name:"逆击(华雄)",type:SkillType.BACK_ATTACK,subType:[SkillSubType.ATTACK_COUNT],attacks:[0.75,0.75],probability:50,explanation:"{probability}几率反击两次。"},
{id:43,name:"大喝(关兴)",type:SkillType.ATTACK,subType:[SkillSubType.ATTACK_COUNT,SkillSubType.NO_COUNTER],attacks:[1.5],probability:40,explanation:"{probability}几率1.5倍暴击，大喝的强大气势令敌军无法反击。"},
{id:44,name:"冲锋(张苞)",type:SkillType.ATTACK,subType:[SkillSubType.ATTACK_COUNT,SkillSubType.PENETRATE],attacks:[1.5],probability:40,explanation:"{probability}几率1.5倍暴击，附带穿透效果。"},
...
{id:50,name:"肉搏(周泰)",type:SkillType.BACK_ATTACK,subType:[SkillSubType.PENETRATE],probability:50,explanation:"反击时附带穿透效果。"},
...
{id:54,name:"倾国(貂蝉)",type:[SkillType.ATTACK, SkillType.HERT],subType:[SkillSubType.HERT_MINUS,SkillSubType.ENEMY_AID],hert:0.5,condition:{type:"SoldierId",value:13},aids:[22],aidCount:1,aidRects:[{x:0,y:0}],probability:100,explanation:"使用女兵兵种时,受到攻击时有几率将伤害减半,其倾国的美色让敌军无法动弹(定身效果)。"},
...
{id:71,name:"突击(夏侯惇)",type:[SkillType.ATTACK_END,SkillType.ATTACK],subType:[SkillSubType.ATTACK_COUNT,SkillSubType.FALL_BACK],attacks:[1.2],probability:35,explanation:"重击敌军的同时令敌军后退一格，如果后方存在部队无法后退时，则对后方部队产生撞击伤害。对建筑无效。"},
{id:72,name:"突破(乐进)",type:[SkillType.ATTACK_END,SkillType.ATTACK],subType:[SkillSubType.BREAK_THROUGH],aids:[3],aidCount:1,aidRects:[{x:0,y:0}],probability:35,explanation:"提升自身防御之后穿透到敌军背后，如果后方存在部队无法后退时，则对后方部队产生撞击伤害。"},
{id:73,name:"逆势反击(张郃)",type:SkillType.ENEMY_BACK_ATTACK_END,subType:[SkillSubType.ATTACK_COUNT],attacks:[0.75],probability:50,explanation:"主动攻击时依然对敌军的攻击进行反击。"},
{id:74,name:"白耳(陈到)",type:SkillType.ATTACK_END,subType:[SkillSubType.FALL_BACK],probability:30,explanation:"白耳兵强大的攻击力迫使敌军后退一格，如因后方存在部队无法后退时,则产生撞击伤害。对建筑无效。"},
{id:75,name:"冲击(张辽)",type:SkillType.ATTACK,subType:[SkillSubType.ENEMY_AID,SkillSubType.PENETRATE],aids:[2],aidCount:1,aidRects:[{x:0,y:0}],probability:50,explanation:"用力冲向敌军,强大的冲力令敌军胆寒,除了令敌军攻击力受损之外,还可以将伤害蔓延到后方的敌军。"},
{id:76,name:"运筹(陈宫)",type:SkillType.STRATEGY_ATTACK,subType:[SkillSubType.STRATEGY_COUNT],strategy_attacks:[1.5],aidCount:1,thrift:1,probability:40,explanation:"{probability}几率在使用法术攻击敌军时1.5倍暴击。"},
];
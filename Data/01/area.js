	...
	seigniors : [{
		...
		areas : [{
			...
			items : [
				...
				{item_id:90,count:1}],
			generals:[
				{chara_id:1,lv:3,feat:817,loyalty:100,equipments:[{item_id:22}]},
				{chara_id:2,lv:3,feat:166,loyalty:50,equipments:[{item_id:18}]},
				{chara_id:3,lv:3,feat:166,loyalty:50,equipments:[{item_id:17}]},

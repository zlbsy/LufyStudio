...
public class Lufylegend {
    ...
    public String readFile(String filePath) {
        try {
            ...
            InputStream inputStream = assetManager.open(Lufylegend.gamePath + "Data/bml.txt");
        ...
        return "";
        /*String fullfilename = Lufylegend.gamePath + "Data/bml.txt";
        print("fullfilename="+fullfilename);
        File jfile = new File(fullfilename);
        print("jfile.exists()="+jfile.exists());
        if (jfile.exists())
        {
            try {
    ...
    public void playSE(String name, int volume){
        soundPool.play(soundIds.get(name), 1.0f, 1.0f, 0, 0, 1);
    }
    @JavascriptInterface
    ...
    public void playBGM(String name, int volume){
        ...
        mediaPlayer = MediaPlayer.create(context, soundIds.get(name));
        mediaPlayer.start();
    }
    @JavascriptInterface

...
var SingleCombatCommandProbability = (function(){
	...
	obj[SingleCombatCommand.CHARGE] = 1;
	obj[SingleCombatCommand.HEAL] = 2;
	obj[SingleCombatCommand.BUFFER] = 1;
...
var SingleCombatCommandChange = (function(){
	...
	data[SingleCombatCommand.BIG_ATTACK] = [SingleCombatCommand.ATTACK, SingleCombatCommand.CHARGE,SingleCombatCommand.HEAL,SingleCombatCommand.BUFFER];
	data[SingleCombatCommand.DEFENCE] = [SingleCombatCommand.ATTACK, SingleCombatCommand.DODGE];
	data[SingleCombatCommand.DODGE] = [SingleCombatCommand.DOUBLE_ATTACK, SingleCombatCommand.CHARGE,SingleCombatCommand.HEAL,SingleCombatCommand.BUFFER];

...
Language.data = {
	...
	"marry_target":"婚配相手",
	"couples":"夫婦",
	"battle_generals_list":"武将一覧",
	"tournaments":"武術大会",
	"tournaments_introduction":"2年に1回の武術大会の時間になりました!優勝したら、特別な商品をもらうことができます。",
	"tournaments_join_confirm":"2年に1回の武術大会を参加しますか？",
	"tournaments_select_toast":"武術大会に参加する武将を選択してください！",
	"tournaments_select":"出戦武将",
	"tournaments_result_talk_0":"一回でも勝てなくて、恥ずかしい...",
	"tournaments_result_talk_1":"その程度か、まだ全力を出していないぞ!",
	"tournaments_result_talk_2":"くそっ、優勝はもう少しだけ...",
	"tournaments_result_talk_4":"残念、四強までか...",
	"tournaments_get_message_0":"勝ていないですが、慰めの報酬：\n{0}",
	"tournaments_get_message_1":"武術大会に優勝した、報酬：\n{0}",
	"tournaments_get_message_2":"武術大会の二位に入賞した、報酬：\n{0}",
	"tournaments_get_message_4":"武術大会の四強に入賞した、報酬：\n{0}",
	"history_reward_message":"獲得した戦利品：\n{0}",
	"can_not_move":"今は移動できません!",
	"use_strategy_terrain_error":"{0}はこの地形の上に使用できません!",
	"use_strategy_belong_error":"{0}に使用できません!",
	"historical_battle":"歴史の戦役",
	"seignior_level_condition":"勢力レベル条件:{0}",
	"seignior_level_error":"勢力レベルが足りない!",
	"arm_expedition_condition":"使える予備兵",
	"food_condition":"使える食糧",
	"historical_food_message":"*使う食糧と予備兵は君主のいる都市から取ります。",
	"must_battle_generals":"必須武将:{0}/{1}",
	"can_battle_generals":"参加可能武将:{0}/{1}",
	"must_battle_generals_label":"必须武将が足りない！",
	"special_support_generals":"特殊な支援武将",
	"detail":"詳細",
	...
	"auto_talk_NewYearPresent":"中国の新年になります、新年おめでとうございます！《三国記》は装備の《{0}》をプレゼントします!",
	...
	"return_top":"トップに戻る",
	"hurt_preview":"傷:{0}\n命:{1}%",
	"dialog_marry_message":"味方の{0}は{1}と結婚しました、忠誠度アップしました、全属性は2アップしました、スキル「同甘共苦」を追加しました。",
	"dialog_marry_error_message":"婚配できる武将が存在しません、功績が1000以上であり、未婚の男性武将しか婚配できません。",
	"dialog_exile_message":"{0}を追放しますか？",
	...
	//"repair_robber_confirm_message":"{0}在执行修补的时候发现城外有强盗出没，要进行讨伐吗？",
	...
	"dialog_generals_level_error":"この武将はレベルアップできません。",
	"dialog_loyalty_level_error":"この武将は忠誠度がアップできません。",
	...
	"dialog_arm_level_error":"<font size='21' color='#D3D3D3'>兵科が進化できません、熟練度は 「<font size='21' color='#FAFAD2'>{0}</font>」以上が必要です 。</font>",
	"dialog_arm_level_confirm":"<font size='21' color='#D3D3D3'>兵科を 「<font size='21' color='#FAFAD2'>{0}</font>」 に進化しますか？</font>",
	"evolution":"進化",
	"prize":"褒賞",
	"prize_all":"全て褒賞",
	"name":"名前",
	...
	"change_face":"顔画像変更",
	"change_monarch":"君主選択",
	"monarch_die":"{0}が亡くなりました、{1}が新しい君主になりました！",
	"monarch_die_select":"味方の{0}が亡くなりました、新しい君主を決めてください！",
	"monarch_die_over":"{0}が亡くなりました！",
	"generals_die_over":"味方の{0}が亡くなりました！",
	"gender_male":"男",
	"gender_female":"女",
	"terrain":"地形",
	"release":"釈放",
	...
	"attack_intelligence_enemy":"敵軍兵力:{0}\n敵軍武将:{1}",
	"attack_intelligence_self":"味方兵力:{0}\n味方武将:{1}",
	"toast_appearances_position_select":"「{0}」の位置を選択して！",
	...
	"history_clear_error_message":"この戦役はクリア済みです。",
	"auto_play_confirm_message":"自動的に1回バトルする，いいですか？",
	...
	"referralCharacterTalk":"私の友人の [{0}] は明主を探していますが、紹介させていただきます。",
	"referralCharacterTargetTalk":"{0} でございます、嬉んで臣下となりましょう!",
	"rain":"雨",
	"cloud":"雾",
	"snow":"雪",
	"sunny":"晴",
	...
	"flood":"水災",
	"plagueOfLocusts":"蝗害",
	"floodControlMessage":"{0}は百姓と一緒に大堤を建設して、{1}の治水能力が強くなりました。",
	"plagueOfLocustsControlMessage":"{0}は百姓に蝗害除去の方法を教えて、{1}の蝗害除去の能力が強くなりました。",
	"floodControl":"治水",
	"plagueOfLocustsControl":"蝗害除去",
	"floodMessage":"「集中豪雨により、{0}」水災が発生しました。",
	"plagueOfLocustsMessage":"「{0}」蝗害が発生しました。",
	"label_equip":"装備",
	"remove_equip":"装備解除",
	"label_use":"使用",
	"label_sale":"売却",
	...
	"resolve_quantity_select":"分解個数の選択：",
	"dialog_city_levelup_error":"レベルアップ中です",
	"soldier_terrain_message":"{0}の地形効果。",
	"born":"出生",
	"life":"寿命",
	"personalLoyalty":"義気",
	"disposition":"性格",
	"ambition":"野心",
	"compatibility":"相性",
	"restraint_attack":"強弱(攻撃)",
	"restraint_attack_passive":"強弱(傷害)",
	"restraint_attack_message":"{0}は他の部隊を攻撃する時の効果。",
	"restraint_attack_passive_message":"他の部隊は{0}を攻撃する時の効果。",
	"belong":"所属",
	"identity":"身份",
	"status":"状態",
	"effect":"効果",
	...
	"spy":"諜報",
	"appoint":"委任",
	"appoint_internal":"内政重視",
	"appoint_explore":"探索重視",
	"appoint_military":"軍事重視",
	"appoint_random":"ランダム",
	"remove_appoint":"解除委任",
	"transport":"物資の輸送",
	"transport_job":"輸送",
	...
	"military":"軍師の策",
	"military_started":"軍師の策【{0}】は発動した！",
	"soldiers_image":"兵科画像",
	"growing":"能力の成長",
	"breakthrough":"成長限界突破",
	"running_get_message":"{0}は{1}を実行した時、百姓は{2}を進献しました。"
};
Language.itemData = {
	"item_name_1":"方壶",
	"item_explanation_1":"武将の忠誠度をアップする。",
	"item_name_2":"美酒",
	"item_explanation_2":"武将の忠誠度をアップする。",
	"item_name_3":"香囊",
	"item_explanation_3":"武将の忠誠度をアップする。",
	"item_name_4":"玉环",
	"item_explanation_4":"武将の忠誠度をアップする。",
	"item_name_5":"修炼符",
	"item_name_6":"修炼符",
	"item_name_7":"修炼符",
	"item_name_8":"修炼符",
	"item_name_9":"修炼符",
	"item_name_10":"練兵金令",
	"item_explanation_10":"今使っている兵科の熟練度をアップする。",
	"item_name_11":"練兵銅令",
	"item_explanation_11":"今使っている兵科の熟練度をアップする。",
	"item_name_12":"練兵鉄令",
	"item_explanation_12":"今使っている兵科の熟練度をアップする。",
	"item_name_13":"元帥印",
	"item_explanation_13":"武将の功績をアップする。",
	"item_name_14":"将軍印",
	"item_explanation_14":"武将の功績をアップする。",
	"item_name_15":"将印",
	"item_explanation_15":"武将の功績をアップする。",
	"item_name_16":"方天画戟",
	"item_name_17":"丈八蛇矛",
	"item_name_18":"青龍偃月刀",
	"item_name_19":"虎頭湛金槍",
	...
	"item_name_97":"赤戦石",
	"item_explanation_97":"装備を強化する用です、ランダムで物攻関連のスキルを追加する。",
	"item_name_98":"赤法石",
	"item_explanation_98":"装備を強化する用です、ランダムで法攻関連のスキルを追加する。",
	"item_name_99":"赤辅石",
	"item_explanation_99":"装備を強化する用です、ランダムで攻撃以外のスキルを追加する。",
	"item_name_100":"赤佐石",
	"item_explanation_100":"装備を強化する用です、ランダムで内政関連のスキルを追加する。",
	"item_name_101":"紫戦石",
	"item_explanation_101":"装備を強化する用です、武力、统率、敏捷の一つを追加する、20%の確率でランダムで物攻関連のスキルを追加する。",
	"item_name_102":"紫法石",
	"item_explanation_102":"装備を強化する用です、知力、统率、運気の一つを追加する、20%の確率でランダムで法攻関連のスキルを追加する。",
	"item_name_103":"紫辅石",
	"item_explanation_103":"装備を強化する用です、知力、敏捷、運気の一つを追加する、20%の確率でランダムで攻撃以外のスキルを追加する。",
	"item_name_104":"紫佐石",
	"item_explanation_104":"装備を強化する用です、敏捷、運気、统率の一つを追加する、20%の確率でランダムで内政関連のスキルを追加する。",
	"item_name_105":"青戦石",
	"item_explanation_105":"装備を強化する用です、攻撃力、防御力、爆発力の一つを追加する、10%の確率でランダムで物攻関連のスキルを追加する。",
	"item_name_106":"青法石",
	"item_explanation_106":"装備を強化する用です、精神力、防御力、爆発力の一つを追加する、10%の確率でランダムで法攻関連のスキルを追加する。",
	"item_name_107":"青辅石",
	"item_explanation_107":"装備を強化する用です、精神力、爆発力、士气の一つを追加する、10%の確率でランダムで攻撃以外のスキルを追加する。",
	"item_name_108":"青佐石",
	"item_explanation_108":"装備を強化する用です、爆発力、爆発力、防御力の一つを追加する、10%の確率でランダムで内政関連のスキルを追加する。",
	"item_name_109":"緑戦石",
	"item_explanation_109":"装備を強化する用です、武力、统率、敏捷の一つを追加する。",
	"item_name_110":"緑法石",
	"item_explanation_110":"装備を強化する用です、知力、统率、運気の一つを追加する。",
	"item_name_111":"緑辅石",
	"item_explanation_111":"装備を強化する用です、知力、敏捷、運気の一つを追加する。",
	"item_name_112":"緑佐石",
	"item_explanation_112":"装備を強化する用です、敏捷、運気、统率の一つを追加する。",
	"item_name_113":"黄戦石",
	"item_explanation_113":"装備を強化する用です、攻撃力、防御力、爆発力の一つを追加する。",
	"item_name_114":"黄法石",
	"item_explanation_114":"装備を強化する用です、精神力、防御力、爆発力の一つを追加する。",
	"item_name_115":"黄辅石",
	"item_explanation_115":"装備を強化する用です、精神力、爆発力、士气の一つを追加する。",
	"item_name_116":"黄佐石",
	"item_explanation_116":"装備を強化する用です、爆発力、爆発力、防御力の一つを追加する。",
...
Language.soldierData = {
	...
	"explanation_wun":"能力的には武道家系と似ているが、HPは低い。毎ターン周囲の異常状態の自軍部隊を回復させる。",
	"explanation_xlqb":"防御と移動が高く8方向に攻撃が可能な攻撃性の高い戦車風のユニットだが、策略には非常に弱い。",
	"explanation_hd":"大河や浅瀬などの水上の地形適正が高いユニット。水系の攻撃系策略も使える。",
	"explanation_xxs":"熊に攻撃させるユニット。虎使い同様、策略には非常に弱い。攻撃を受けると毒状態に陥る可能性がある。",
	"explanation_xhs":"虎に攻撃させるユニット。策略には非常に弱い。攻撃を受けると不動状態に陥る可能性がある。",
	"explanation_dd":"海賊同様、水上の地形適正が高いユニット。水系や火系の攻撃系や妨害系の策略を使用し、文官ユニットながら攻撃力は高め。",
	"explanation_zss":"策士系、道士系、風水士系の全ての策略が使える最強の文官ユニット。",
	"explanation_tjb":"藤のつるで編んだ鎧を身につけた精鋭部隊である。この鎧は軽量で水にも強く、この藤甲を着た兵士は、刀も矢も受け付けぬと言う。",
	"explanation_ymq":"騎兵同様、攻撃が高いユニットです、瞬発が騎より高いですが、防御力が弱いです。そして策略に非常に弱い。",
	"explanation_fdb":"弓兵同様、間接攻撃が可能なユニット。弓兵より攻撃力が強いですが、士気が弱いです。",
	"explanation_ymr":"攻撃力も防御力も強いユニット。地形適正も良いですが、精神と士気が非常に弱い。",
	"explanation_qzb":"戦闘力が強いユニット。4方向しか攻撃できないですが、攻撃範囲が広い。",

	"explanation_jw":"全能力が平均して高く、敵に回すと厄介である。",
	"explanation_zbb":"攻撃力は平凡だが、防御とHP（耐久値）が高いユニット。8方向攻撃が可能である。",
	"explanation_nub":"間接攻撃が可能なユニット。攻撃範囲が広いが、隣接する敵には攻撃できないため接近戦には弱い。",
	"explanation_zqb":"移動範囲が広く攻撃が高いユニットだが、険しい道（山地や水路）には弱い、4方向しか攻撃できない。",
	"explanation_nqb":"騎兵系の移動範囲の広さと弓兵系の間接攻撃の特性を併せ持つユニットである、2マス離れた4方向しか攻撃できないため接近戦に非常に弱い。",
	"explanation_zpc":"全ユニットで最も広い射程距離を持つ間接攻撃が出来るユニットだが、命中率は低く移動範囲も狭い。",
	"explanation_qs":"瞬発が高いため連続攻撃が発生しやすく回避率も高いユニット。水上の地形適正が高いのも特徴といえる。また、毒煙系や気合の策略も使える。",
	"explanation_yz":"林や山地での地形適正が高く、地系の攻撃系策略を使えるユニット、士気が高いため会心の一撃が発生しやすいが、精神が低いため策略には弱い。",
	"explanation_cm":"火系、水系、地系などの攻撃系策略のエキスパートといえるユニット。他にも小補給など若干の回復系策略も使用できる。",
	"explanation_fss":"HP・MPや状態異常の回復など回復系、味方のユニット性能を上げる向上系の策略を操る支援的なユニット。",
	"explanation_hss":"毒煙や誘惑など追加効果のついた攻撃や敵のユニット性能の低下や状態異常を起こさせる妨害系策略を操るユニット。",
	"explanation_qmcm":"騎兵系の移動範囲の広さと策士系の多彩な攻撃系策略の特性を併せ持つユニット。",
	"explanation_nvj":"能力的には武道家系と似ているが、HPは低い。毎ターン周囲の異常状態の自軍部隊を回復させる。",
	"explanation_xltq":"防御と移動が高く8方向に攻撃が可能な攻撃性の高い戦車風のユニットだが、策略には非常に弱い。",
	"explanation_dhd":"大河や浅瀬などの水上の地形適正が高いユニット。水系の攻撃系策略も使える。",
	"explanation_ddd":"海賊同様、水上の地形適正が高いユニット。水系や火系の攻撃系や妨害系の策略を使用し、文官ユニットながら攻撃力は高め。",
	"explanation_kzss":"策士系、道士系、風水士系の全ての策略が使える最強の文官ユニット。",
	"explanation_dyb":"瞬発が高いため連続攻撃が発生しやすく回避率も高いユニット。水上の地形適正が高いのも特徴といえる。また、毒煙系や気合の策略も使える。",
	"explanation_ber":"防御高いユニット。瞬発も弱くない。",
	"explanation_wdfj":"間接攻撃が可能な強いユニット。",
	"explanation_hbq":"攻撃力も防御力も高いユニット。",
	"explanation_hwj":"防御とHP（耐久値）が高いユニット。弓兵系に強いです。",
	"explanation_jfb":"水上の地形適正が高いユニット。",
	"explanation_bmyc":"間接攻撃も隣接攻撃もできるユニット。",
	"explanation_fxj":"熊に攻撃させるユニット。攻撃力が高い",
	"explanation_xzy":"攻撃力も瞬発力も高いユニット。",
	"explanation_xr":"文官ユニットながら攻撃力は高め。",
	
	"explanation_skill":"特技あり【{0}】{1}(発動率:{2}％)",
	"explanation_newcount":" {0}成長を突破することができ、優秀な武将がもっと高い能力を獲得できる。"
};
...
Language.skillData = {
	...
	"se_2":"傷害を0にする。",
	"s_3":"隔山打牛",
	"se_3":"傷害を隣の敵に広がります。隣の敵がいない場合、目標を会心攻撃する。",
	"s_4":"天下無双",
	"se_4":"敵に二回会心攻撃する、相手の隣の敵は防御力を下降させる。",
	"s_5":"愈戦愈勇",
	...
	"s_8":"蒼龍覚醒",
	"se_8":"会心攻撃して、敵の能力の一つを下降させる、そして、自分と隣の味方武将が不良状態にならない。",
	"s_9":"幻影",
	...
	"s_39":"陥陣営",
	"se_39":"隣の敵部隊が多ければ多いほど攻撃が強くなる、でも隣の敵部隊が1人しかいない場合、効果がない可能性もあります。",
	"s_40":"強行",
	"se_40":"移動力上昇させる。",
	"s_41":"小覇王",
	...
	"s_44":"突撃",
	"se_44":"損害が1.5倍になり、攻撃方向に２部隊いると共に攻撃する。",
	"s_45":"節糧",
	"se_45":"糧食の消耗を半分にする。",
	"s_46":"商業",
	...
	"s_71":"突撃",
	"se_71":"会心攻撃して、敵軍を1マス後退される。後ろに軍隊が存在して、後退できない時、衝突で損害に与える。建築物に効がありません。",
	"s_72":"突破",
	"se_72":"防御をアップして、敵軍の後ろに突進する。後ろに軍隊が存在して、突進できない時、衝突で損害に与える。",
	"s_73":"逆勢反撃",
	"se_73":"反撃に対して反撃を行う。",
	"s_74":"白耳",
	"se_74":"白耳兵の強い攻撃力で、敵軍を1マス後退される。後ろに軍隊が存在して、後退できない時、衝突で損害に与える。建築物に効がありません。",
	"s_75":"衝擊",
	"se_75":"全力で敵軍に衝擊する、敵軍の攻撃力を下降させて、衝擊損害が後ろにある軍隊に与える。",
	"s_76":"運籌",
	"se_76":"策略攻撃する時、損害が1.5倍になる。",
	"s_77":"神箭",
	"se_77":"弓兵系の兵科を使って、攻撃する時、連続で二回攻撃できる、そして、必ず命中する。",
	"s_78":"霸王重生",
	"se_78":"敵に二回会心攻撃する、自分が一つの能力を上昇させる。",
	"s_79":"算無遺策",
	"se_79":"策略攻撃する時、必ず命中する。そして、損害を隣の敵に広がります。",
	"s_80":"軍神",
	"se_80":"物理攻撃と策略攻撃は必ず命中する。敵の隣は味方部隊が存在したら、損害が大きくなる。味方部隊が多ければ多いほど良い。",
	"s_81":"衝殺",
	"se_81":"攻撃方向に4部隊まで共に攻撃する。",
	"s_82":"横掃",
	"se_82":"物理攻撃する時、攻撃できる敵たちに全部攻撃する。",
	"s_83":"百步穿杨",
	"se_83":"弓兵系の兵科を使って、攻撃する時、損害が10％上昇させる、そして、必ず命中する。",
	"s_84":"兵神",
	"se_84":"策略攻撃が三回になって、必ず命中する。",
	"s_85":"奮戦",
	"se_85":"会心攻撃。",
	"s_86":"臥薪嘗胆",
	"se_86":"敵の行動回合に攻撃を受けたら、自分が攻撃するとき、損害が20%上昇させる。複数加算有効。",
	"s_87":"快速連撃",
	"se_87":"軽くて、二回攻撃する。攻撃損害は普通の0.6倍になる。",
	"s_88":"防守",
	"se_88":"傷害を20%減少する。",
	"s_89":"騎術",
	"se_89":"騎兵を利用する時、攻撃範囲が大きくなります。",
	"s_90":"米袋",
	"se_90":"自分が糧食を消耗しない。",
	"s_91":"移動攻撃",
	"se_91":"１単位を移動すると、攻撃損害が5%上昇させる。",
	"s_92":"英龙の気",
	"se_92":"攻撃を受ける時、相手にもある程度の損害を与える。そして、自分の傷害を0にする。",
	"s_93":"仁龙の気",
	"se_93":"自分の傷害を0にして、自分を治療する。",
	"s_94":"賢龙の気",
	"se_94":"自分の傷害を0にして、自分が一つの能力を上昇させる。",
	"s_95":"経商",
	"se_95":"金銭の収入を上昇する。",
	"s_96":"生産",
	"se_96":"食糧の収入を上昇する。",
	...
	"se_97":"災害が起こりません。",
	"s_98":"短剣",
	"se_98":"短剣を装備して、間接攻撃が可能なユニットでも、接近戦できます。",
	"s_99":"募粮",
	"se_99":"毎月食糧を獲得できます、戦闘中に糧食の消耗を半分にする。",
	"s_100":"憤怒",
	"se_100":"一騎討ちをやる時毎回に怒气を10増加する。",
	"s_101":"同甘共苦",
	"se_101":"夫婦同心，士気が高くなる。",
	
	"m_1":"炎海",//周瑜
	"mi_1":"火神を召喚して、敵軍を焼き討ち、敵が燃焼状態にする。",
	"m_2":"毒雲",//郭嘉
	"mi_2":"毒雲で敵軍を包んで、全部の敵軍に毒で攻撃する。",
	"m_3":"救世",//华佗
	"mi_3":"味方の全軍の傷兵を治療し、異常状態を回復する。",
	"m_4":"機關",//黄月英
	"mi_4":"黄月英が発明した特殊な機械、全部の敵軍に妨害系策略で攻撃する。",
	"m_5":"木牛流馬",//诸葛亮
	"mi_5":"5回合以内に味方の全軍が毎回に兵力を3%回復して、糧食の消耗を0にする。",
	"m_6":"屏障",//司马懿
	"mi_6":"味方の全軍に特殊な屏障を作って、任意の物理や策略の攻撃を一回免疫する。",
	"m_7":"强身I",//普通
	"mi_7":"味方の全軍の能力を一つ上昇させる、【士気】。",
	"m_8":"强身II",//普通
	"mi_7":"味方の全軍の能力を一つ上昇させる、【士気，瞬発力】。",
	"m_9":"强身III",//普通
	"mi_7":"味方の全軍の能力を一つ上昇させる、【士気，瞬発力，防御】。",
	"m_10":"强身IV",//普通
	"mi_7":"味方の全軍の能力を一つ上昇させる、【士気，瞬発力，防御，攻撃】。",
	"m_11":"强身V",//普通
	"mi_7":"味方の全軍の能力を一つ上昇させる、【士気，瞬発力，防御，攻撃，精神】。",
	"m_12":"压迫I",//普通
	"mi_12":"全部の敵軍の能力を一つ下降させる、【士気】。",
	"m_13":"压迫II",//普通
	"mi_13":"全部の敵軍の能力を一つ下降させる、【士気，瞬発力】。",
	"m_14":"压迫III",//普通
	"mi_14":"全部の敵軍の能力を一つ下降させる、【士気，瞬発力，防御】。",
	"m_15":"压迫IV",//普通
	"mi_15":"全部の敵軍の能力を一つ下降させる、【士気，瞬発力，防御，攻撃】。",
	"m_16":"压迫V",//普通
	"mi_16":"全部の敵軍の能力を一つ下降させる、【士気，瞬発力，防御，攻撃，精神】。",
	"m_17":"連鎖",//庞统
	"mi_17":"連続攻撃が発生しやすくします、2回合有効。",
	"m_18":"高昂",//陆逊
	"mi_18":"会心の一撃が発生しやすくします、2回合有効。",
	"m_19":"耗糧",//李儒
	"mi_19":"敵軍の糧食の消耗を倍にする、5回合有効。",
	"m_20":"凝聚",//贾诩
	"mi_20":"味方の全軍のスキルが必ず発動する(武将自身のスキルにだけ有効です)、2回合有効。",
	"m_21":"众志成城",//审配
	"mi_21":"味方の全軍の傷害を20%減少する、2回合有効。",
};

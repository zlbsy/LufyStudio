...
var LPanel = (function () {
	function LPanel (bitmapData, w, h, x1, x2, y1, y2, overlapping) {
		...
		if (typeof bitmapData == "string") {
			...
			bitmapData.draw(d);
			if(d.die)d.die();
			if(d.cached)d.cached();
			if(d.removeAllChild)d.removeAllChild();
		}
